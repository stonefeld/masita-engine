...
namespace Masita {
    ...
    void ImGuiLayer::OnEvent(Event& event)
    {
        ...
        dispatcher.Dispatch<MouseMovedEvent>(MA_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
        ...
        dispatcher.Dispatch<WindowResizeEvent>(MA_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
    }
